// Generated by Avo VERSION 48.34.0, PLEASE EDIT WITH CARE
/* eslint-disable */
...
_avo_invoke_meta = function _avo_invoke_meta(env, type, messages, origin) {
  ...
  function cliInvoked(properties) {
    ...
    if (__AVO_DEV__) {
      ...
      // debug console in Avo
      _avo_invoke(__AVO_ENV__, "qqpIQEK11", "9ad1c9d148fe3f942ced340573f1bfc2e10ee87d8ca04a2c6bfe2275571e6607", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType}); }), 'event');
  ...
  function cliConflictResolveAttempted(properties) {
    ...
    if (__AVO_DEV__) {
      ...
      // debug console in Avo
      _avo_invoke(__AVO_ENV__, "Un5dTEMQYy", "8de6661b415452862b42ac3a7ab2d9043269bbe38754c1fdeb13c37af3ab412e", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType}); }), 'event');
  ...
  function cliConflictResolveFailed(properties) {
    ...
    if (__AVO_DEV__) {
      ...
      // debug console in Avo
      _avo_invoke(__AVO_ENV__, "4ZhoijIA2U", "097090b93f3564b53acee60da6eeee5c8aeaf904478a9f6b9b8b2124f9cb6097", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType}); }), 'event');
  ...
  function cliConflictResolveSucceeded(properties) {
    ...
    if (__AVO_DEV__) {
      ...
      // debug console in Avo
      _avo_invoke(__AVO_ENV__, "yj_554q43i", "f85f52811d0cd04a0d16b3abac925788873d98812aca73018ef4f79f22541822", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType}); }), 'event');
