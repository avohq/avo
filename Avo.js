// Generated by Avo VERSION 60.34.0, PLEASE EDIT WITH CARE
/* eslint-disable */
...
_avo_invoke_meta = function _avo_invoke_meta(env, type, messages, origin) {
   ...
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/54e92613-090c-4f0b-afeb-ed720eff3422}
   */
   ...
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/7aa64217-bb89-44f5-9a68-f3bc0255a864}
   */
   ...
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/qqpIQEK11}
   */
  function cliInvoked(properties) {
    ...
    if (__AVO_DEV__) {
      ...
      // debug console in Avo
      if (!__AVO_NOOP__) {
        _avo_invoke(__AVO_ENV__, "qqpIQEK11", "17920512c979b2e07dfbf9570139a878e2c58537727bf3502d28aafff2d42db1", messages.map(function(m) { return Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType}); }), 'event');
      }
   ...
   * @param {bool} properties.cliInvokedByCi - True iff process.env.CI is set.
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/JCwfVYXTS}
   */
   ...
   * @param {string} properties.schemaName - Name of the schema that this event is related to.
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/Un5dTEMQYy}
   */
   ...
   * @param {string} properties.branchName - The name of the branch that this event is related to.
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/4ZhoijIA2U}
   */
   ...
   * @param {string} properties.branchName - The name of the branch that this event is related to.
   *
   * @see {@link https://www.avo.app/schemas/fwtXqAc0fCLy7b7oGW40/branches/Eiv9h673k/events/yj_554q43i}
   */
